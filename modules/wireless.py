...
def wireless():
    ...
    subprocess.call("apt install kali-tools-802-11 kali-tools-headless kali-tools-passwords kali-tools-wireless hcxdumptool hcxtools hostapd libssl-dev libffi-dev build-essential python3-pyqt5 -y", shell=True)
